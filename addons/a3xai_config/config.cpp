...
class CfgA3XAISettings {
	...
	levelRequiredLauncher = 3;  // Only the hardest AI get launchers
	
	//List of launcher-type weapons that AI can use.
	launcherTypes[] = {
		"launch_RPG32_F",        	// RPG-32 (Vanilla)
		"CUP_launch_RPG7V",      	// RPG-7V (CUP)
		"CUP_launch_RPG18",      	// RPG-18 (CUP)
		"launch_B_Titan_short_F",	// Titan AT (Vanilla)
		"launch_I_Titan_F",      	// Titan AA (Vanilla)
		"launch_MRAWS_green_F",  	// MRAWS (Vanilla)
		"CUP_launch_NLAW",       	// NLAW (CUP)
		"CUP_launch_FIM92Stinger", 	// FIM-92 Stinger (CUP)
		"CUP_launch_SMAW",       	// SMAW (CUP)
		"launch_B_Titan_F",      	// Titan AT Launcher (Vanilla)
		"launch_I_Titan_long_F", 	// Titan Long (Vanilla)
		"launch_Morozov_F",      	// 9K111 Fagot (CUP)
		"launch_RPG26_F",        	// RPG-26 (Vanilla)
		"CUP_launch_SRAW",       	// SRAW (CUP)
		"CUP_launch_IGLA",       	// IGLA (CUP)
		"CUP_launch_PANTHER",    	// PANTHER (CUP)
		"CUP_launch_JAVELIN",    	// Javelin (CUP)
		"launch_B_ZU23_F",      	// ZU-23 (Vanilla)
		"CUP_launch_SA18"        	// SA-18 Igla 
	}; 
	
	//Maximum number of launcher weapons allowed per group (Default: 1)
	// launchersPerGroup = 3;
	launchersPerGroup = 1;  // Only **one** AI per group can have a launcher 
	...
	spawnHunterChance = 0.30; // 0.06 30% chance AI will actively hunt a player  
	...
	distanceBetweenRandomSpawns = 1250;
	...
	//Enable player use of AI vehicles. Players must either disable the vehicle or kill all units of the group in order to access the vehicle. (Default: 0 vechiles not avilable to players)
	...
	airVehicleList[] = {
		...
		// {"B_Heli_Light_01_armed_F", 2},      	// AH-9 Pawnee - B (Vanilla)
		...
		// Additional Aircraft (Fixed-Wing or Other)
		// {"I_Plane_Fighter_01_F", 1},            	// L-159 ALCA (Fixed-Wing) - I (Vanilla)
		// {"B_Plane_CAS_01_F", 1},                 	// Wipeout - B (Vanilla)

		// Heli
		{"B_Heli_Transport_01_F",2},			// GHOST HAWK
		{"B_Heli_Transport_03_F",2},			// 
		{"C_Heli_Light_01_civil_F",2},			// M-900 (Civilian) – Light transport and reconnaissance
		{"I_Heli_Transport_02_F",1},           		// Orca (Unarmed) - I (Vanilla)
		{"I_Heli_light_03_unarmed_F",2},		// Hellcat (Unarmed) – Agile and versatile transport
		{"O_Heli_Light_02_unarmed_F",2},		// Orca (Unarmed) – Common medium-lift transport
		{"O_Heli_Transport_04_F",1},           		// Mohawk - O (Vanilla)

		// BLACK FISH
		{"B_T_VTOL_01_infantry_F",2},			// Blackfish (Infantry Transport)
		...
		// PLANE
		{"C_Plane_Civil_01_F",3},			// Caesar BTT – A light civilian aircraft useful for scouting
		{"O_T_VTOL_02_infantry_dynamicLoadout_F",1},	// Xi'an VTOL (Transport) – A futuristic medium transport with vertical takeoff capabilities
		{"O_Heli_Transport_04_covered_F",1}		// Taru (Covered) – Medium-lift transport
	};
	...
	*/
	...
	skill3[] = {
		...
		{"aimingAccuracy",0.20,0.30},  // AI will still be accurate but not godlike  
