...
A3XAI_airReinforcementDetection = compileFinal preprocessFileLineNumbers format ["%1\compile\A3XAI_behavior\A3XAI_airReinforcementDetection.sqf",A3XAI_directory];
